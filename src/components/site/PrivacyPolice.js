...
export default function PrivacyPolice() {
  return (
    <div>
      ...
      <p>
        A sua privacidade é importante para nós. É política do Diogo Basso
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site <a href="diogobasso.com.br/">Diogo Basso</a>, e
      ...
      <p>
        ...
        nós. Esteja ciente de que não temos controle sobr/e o conteúdo e
      ...
      <p>
        ...
        alguma dúvida sobr/e como lidamos com dados do usuário e informações
      ...
      <p>
        ...
        'quebr/ar' certos elementos da funcionalidade do site.
      </p>
      ...
      <ul>
        <li>
          ...
          em algunscasos, eles poderão permanecer posteriormente para lembr/ar
        ...
        <li>
          ...
          lembr/ar dessa ação. Isso evita que você precise fazer login sempre
          que visitar uma nova página. Esses cookies são normalmente removidos
          ou limposquando você efetua logout para garantir que você possa
        ...
        <li>
          ...
          ou e-mail e os cookies podem ser usados ​​para lembr/ar se você já
          está registrado e se deve mostrar determinadas notificaçõesválidas
        ...
        <li>
          ...
          seja lembr/ado entre as páginas, para que possamos processá-lo
          adequadamente.
          <br />
          <br />
        </li>
        <li>
          ...
          cookiespara lembr/ar quem já participou numa pesquisa ou para fornecer
        ...
        <li>
          ...
          os cookies podem ser configurados para lembr/ar os detalhes do
          usuáriopara correspondência futura.
          <br />
          <br />
        </li>
        <li>
          ...
          executado quando você o usa. Para lembr/ar suas preferências,
          precisamosdefinir cookies para que essas informações possam ser
      ...
      <ul>
        <li>
          ...
          podem rastrear itens como quanto tempovocê gasta no site e as páginas
          visitadas, para que possamos continuar produzindo conteúdo atraente.{" "}
        </li>
      </ul>
      <p>
        Para mais informações sobr/e cookies do Google Analytics, consulte a
      ...
      <ul>
        <li>
          ...
          páginas visitadas, o que nos ajuda a entendercomo podemos melhorar o
          site para você.
        </li>
        <li>
          ...
          receba uma experiência consistente enquantoestiver no site, enquanto
          entendemos quais otimizações os nossos usuários mais apreciam.
        </li>
        <li>
          À medida que vendemos produtos, é importante entendermos as
          estatísticas sobr/e quantos visitantes de nosso site realmente compram
          e, portanto, esse é o tipo de dados que esses cookies rastrearão. Isso
          é importante para você, pois significa que podemosfazer previsões de
        ...
        <li>
          ...
          para você.
          <br />
          Para mais informações sobr/e o Google AdSense, consulte as FAQs
          oficiais sobr/e privacidade do Google AdSense.{" "}
        </li>
        <li>
          ...
          projetados para garantir que você forneça os anúnciosmais relevantes
        ...
        <li>
          ...
          possamos creditá-los adequadamente e, quandoaplicável, permitir que
      ...
      <p>
        ...
        informação que o Diogo Basso oferece no site e com caráter enunciativo,
        mas não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          xenofóbica, apostas desportivas (ex.: Betano), jogos de sorte e azar,
          qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou
          contra os direitos humanos;
        </li>
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do Diogo Basso, de seus fornecedores ou terceiros, para
