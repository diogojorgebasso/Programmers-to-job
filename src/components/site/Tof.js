...
export default function Tof() {
  return (
    <div>
      <h2>1. Termos</h2>{" "}
      <p>
        Ao acessar ao site <a href="diogobasso.com.br">Diogo Basso</a>, concorda
      ...
      <p>
        ...
        materiais (informações ou software) no site Diogo Basso , apenas para
      ...
      <p>
        ...
        dessas restrições e poderá ser rescindida por Diogo Basso a qualquer
      ...
      <ol>
        {" "}
        <li>
          Os materiais no site da Diogo Basso são fornecidos 'como estão'. Diogo
          Basso não oferece garantias, expressas ou implícitas, e, por este
        ...
        <li>
          Além disso, o Diogo Basso não garante ou faz qualquer representação
      ...
      <h2>4. Limitações</h2>{" "}
      <p>
        Em nenhum caso o Diogo Basso ou seus fornecedores serão responsáveis
        ...
        ou da incapacidade de usar os materiais em Diogo Basso, mesmo que Diogo
        Basso ou um representante autorizado da Diogo Basso tenha sido
      ...
      <p>
        Os materiais exibidos no site da Diogo Basso podem incluir erros
        técnicos, tipográficos ou fotográficos. Diogo Basso não garante que
        qualquer material em seu site seja preciso, completo ou atual. Diogo
        Basso pode fazer alterações nos materiais contidos em seu site a
        qualquer momento, sem aviso prévio. No entanto, Diogo Basso não se
        compromete a atualizar os materiais.
      </p>{" "}
      <h2>6. Links</h2>{" "}
      <p>
        O Diogo Basso não analisou todos os sites vinculados ao seu site e não é
        responsável pelo conteúdo de nenhum site vinculado. A inclusão de
        qualquer link não implica endosso por Diogo Basso do site. O uso de
        qualquer site vinculado é por conta e risco do usuário.
      </p>{" "}
      <h3>Modificações</h3>{" "}
      <p>
        O Diogo Basso pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        ...
        leis do Diogo Basso e você se submete irrevogavelmente à jurisdição
